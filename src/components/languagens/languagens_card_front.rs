        ...
        <div class="h-[15rem] md:h-[20rem] rounded-xl z-40 bg-[rgba(40,40,40,0.70)] [mask-image:radial-gradient(50%_50%_at_50%_50%,white_0%,transparent_100%)]">
          ...
          <div class="h-40 w-px absolute top-20 m-auto z-40 bg-gradient-to-b from-transparent via-cyan-500 to-transparent animate-move"><div class="w-10 h-32 top-1/2 -translate-y-1/2 absolute -left-10">
            <div class="absolute inset-0">
              <span class="inline-block bg-black" style="position: absolute; top: 78.2508px; left: 34.7318px; width: 2px; height: 2px; border-radius: 50%; z-index: 1; opacity: 1; transform: scale(1.08492) translateZ(0px);"></span>
              <span class="inline-block bg-black" style="position: absolute; top: 103.197px; left: 32.5725px; width: 2px; height: 2px; border-radius: 50%; z-index: 1; opacity: 1; transform: scale(1.17271) translateZ(0px);"></span>
              <span class="inline-block bg-black" style="position: absolute; top: 85.8407px; left: 4.26228px; width: 2px; height: 2px; border-radius: 50%; z-index: 1; opacity: 1; transform: scale(1.16084) translateZ(0px);"></span>
              <span class="inline-block bg-black" style="position: absolute; top: 6.78935px; left: 12.1162px; width: 2px; height: 2px; border-radius: 50%; z-index: 1; opacity: 1; transform: scale(0.501664) translateZ(0px);"></span>
              <span class="inline-block bg-black" style="position: absolute; top: 29.5035px; left: 6.39001px; width: 2px; height: 2px; border-radius: 50%; z-index: 1; opacity: 1; transform: scale(0.13722) translateZ(0px);"></span>
              <span class="inline-block bg-black" style="position: absolute; top: 67.1682px; left: 15.8197px; width: 2px; height: 2px; border-radius: 50%; z-index: 1; opacity: 1; transform: scale(0.960149) translateZ(0px);"></span>
              <span class="inline-block bg-black" style="position: absolute; top: 87.8813px; left: 15.0694px; width: 2px; height: 2px; border-radius: 50%; z-index: 1; opacity: 1; transform: scale(0.605076) translateZ(0px);"></span>
              <span class="inline-block bg-black" style="position: absolute; top: 27.0978px; left: 14.8183px; width: 2px; height: 2px; border-radius: 50%; z-index: 1; opacity: 1; transform: scale(0.487005) translateZ(0px);"></span>
              <span class="inline-block bg-black" style="position: absolute; top: 46.448px; left: 18.5996px; width: 2px; height: 2px; border-radius: 50%; z-index: 1; opacity: 1; transform: scale(0.800202) translateZ(0px);"></span>
              <span class="inline-block bg-black" style="position: absolute; top: 42.0602px; left: 14.6538px; width: 2px; height: 2px; border-radius: 50%; z-index: 1; opacity: 1; transform: scale(1.13584) translateZ(0px);"></span>
              <span class="inline-block bg-black" style="position: absolute; top: 55.543px; left: 17.1304px; width: 2px; height: 2px; border-radius: 50%; z-index: 1; opacity: 1; transform: scale(0.25159) translateZ(0px);"></span>
              <span class="inline-block bg-black" style="position: absolute; top: 25.5763px; left: 2.29028px; width: 2px; height: 2px; border-radius: 50%; z-index: 1; opacity: 1; transform: scale(1.05253) translateZ(0px);"></span>
            </div>
          </div>
        </div>
        </div>
